    ...
    <div className='py-10'>
        <div className='flex flex-col items-center gap-4'>
            ...
            <p className='max-w-[700px] text-gray-600 text-center'>
             ...
             ques fugit inventore, cumque quae corporios ratione teneture eos
             volupattes neque magnem soluta aprieam omnis percipiciates reiciendis
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            ...
            <span className="font-medium">297</span> results
          </p>
        </div>
        <div>
